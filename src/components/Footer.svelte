<footer class="py-16 sm:py-20 md:py-24 px-4 md:px-8">
	...
	>
		...
		<div class="flex flex-col gap-4">
			...
			<a href="https://github.com/sahildhingraa" target="_blank" class="cursor-pointer hover:text-indigo-400 duration-200">
			...
			<a href="https://x.com/novoocaiine" target="_blank" class="cursor-pointer hover:text-indigo-400 duration-200">
